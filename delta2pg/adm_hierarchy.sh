...
INSERT INTO $TABLE SELECT "id","objectid","parentobjid","changeid","regioncode","areacode","citycode","placecode","plancode","streetcode","previd","nextid","updatedate","startdate","enddate","isactive" FROM tmp ON CONFLICT ON CONSTRAINT ${TABLE}_pkey DO UPDATE SET "objectid"=EXCLUDED."objectid","parentobjid"=EXCLUDED."parentobjid","changeid"=EXCLUDED."changeid","regioncode"=EXCLUDED."regioncode","areacode"=EXCLUDED."areacode","citycode"=EXCLUDED."citycode","placecode"=EXCLUDED."placecode","plancode"=EXCLUDED."plancode","streetcode"=EXCLUDED."streetcode","previd"=EXCLUDED."previd","nextid"=EXCLUDED."nextid","updatedate"=EXCLUDED."updatedate","startdate"=EXCLUDED."startdate","enddate"=EXCLUDED."enddate","isactive"=EXCLUDED."isactive";
