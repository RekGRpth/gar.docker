...
INSERT INTO $TABLE SELECT "id","parentid","childid","changeid" FROM tmp ON CONFLICT ON CONSTRAINT ${TABLE}_pkey DO UPDATE SET "parentid"=EXCLUDED."parentid","childid"=EXCLUDED."childid","changeid"=EXCLUDED."changeid","region"=EXCLUDED."region";
