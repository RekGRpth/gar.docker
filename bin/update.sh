...
with _ as (
    ...
    left join gar on gar.parent = addr_obj_parent.objectguid and gar.name = addr_obj.name and gar.type = addr_obj_types.name and gar.object = 'addr_obj' and gar.region = ${DIR}
...
with _ as (
    ...
    left join gar on gar.parent = apartments_parent.objectguid and gar.name = apartments.number and gar.type = apartment_types.name and gar.object = 'apartments' and gar.region = ${DIR}
