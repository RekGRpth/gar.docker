...
) SELECT 'addr_obj' AS object, $REGION AS region, 'update' as command, count(*) FROM u UNION SELECT 'addr_obj' AS object, $REGION AS region, 'insert' as command, count(*) FROM i;
EOF
