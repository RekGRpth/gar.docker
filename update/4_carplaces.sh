...
) SELECT 'carplaces' AS object, $REGION AS region, 'update' as command, count(*) FROM u UNION SELECT 'carplaces' AS object, $REGION AS region, 'insert' as command, count(*) FROM i;
EOF
