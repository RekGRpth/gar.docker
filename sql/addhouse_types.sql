...
CREATE INDEX IF NOT EXISTS addhouse_types_startdate_idx ON addhouse_types USING btree (startdate);
CREATE INDEX IF NOT EXISTS addhouse_types_enddate_idx ON addhouse_types USING btree (enddate);
